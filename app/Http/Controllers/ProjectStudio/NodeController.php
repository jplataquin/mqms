...
class NodeController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        // Get sections belonging to the project
        $sections = $project->Sections()->whereNull('deleted_at')->get();
    ...
    public function children(Request $request)
    {
        ...
        if ($type === 'section') {
            ...
            $contractItems = $section->ContractItems()->whereNull('deleted_at')->get();
            ...
            $components = $contractItem->Components()->whereNull('deleted_at')->get();
            ...
            $componentItems = $component->ComponentItems()->whereNull('deleted_at')->get();
