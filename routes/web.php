...
Route::middleware(['auth',CheckForResetPassword::class,'access_codes'])->group(function () {
    ...
    Route::get('/budget/project/{id}', [App\Http\Controllers\BudgetController::class, 'section_list']);
    Route::get('/budget/section/{id}', [App\Http\Controllers\BudgetController::class, 'contract_item_list']);
    Route::get('/budget/contract_item/{id}', [App\Http\Controllers\BudgetController::class, 'component_list']);
    Route::get('/budget/component/{id}', [App\Http\Controllers\BudgetController::class, 'component_display']);
    ...
    Route::post('/review/bulk/purchase_order/action', [App\Http\Controllers\Review\Bulk\PurchaseOrderBulkReviewController::class, '_action']);
    ...
    Route::get('/purchase_order/_print/{id}', [App\Http\Controllers\PurchaseOrderController::class, '_print']);
   ...
   // Route::get('/report/a/select', [App\Http\Controllers\Report\ReportAController::class, 'select']);
    ...
    Route::get('/coupon/claim/{id}/{code}', [App\Http\Controllers\CouponController::class, 'claim']);
    Route::get('/coupon/generate/{id}', [App\Http\Controllers\CouponController::class, 'generate']);
...
Route::get('/vanilla-datepicker.js', function(){
    ...
    $response = Response::make(File::get(base_path('node_modules/vanillajs-datepicker/dist/js/datepicker-full.js')), 200);
    $response->header("Content-Type", 'text/javascript');
