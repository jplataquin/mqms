...
Route::middleware(['auth:sanctum','access_codes'])->group(function () {
    ...
    Route::get('/accomplishment/project/list', [App\Http\Controllers\AccomplishmentController::class, '_list']);
    Route::get('/accomplishment/section/list', [App\Http\Controllers\AccomplishmentController::class, '_section_list']);
    Route::get('/accomplishment/contract_item/list', [App\Http\Controllers\AccomplishmentController::class, '_contract_item_list']);
    ...
    Route::post('/user/change_password', [App\Http\Controllers\UserController::class, '_change_user_password']);
    ...
    Route::get('/review/bulk/purchase_order/list', [App\Http\Controllers\Review\Bulk\PurchaseOrderBulkReviewController::class, '_list']);
    ...
    //Coupons
    Route::get('/coupon/list', [App\Http\Controllers\CouponController::class, '_list']);
    Route::post('/coupon/create', [App\Http\Controllers\CouponController::class, '_create']);
