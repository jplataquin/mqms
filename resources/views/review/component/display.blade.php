                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="true" class="form-control @if($budget_grand_total_amount > $contract_grand_total) text-danger @endif" value="P {{ number_format($budget_grand_total_amount,2) }}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
