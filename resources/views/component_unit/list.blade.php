...
@section('content')
<div class="container">
<h5>Master Data » Component Unit</h5>
<hr>
    <div class="row">
        <div class="col-lg-4">
...
<script type="module">
    ...
    function renderRows(data){
        ...
        data.map(item=>{
            ...
            row.onclick = ()=>{
                document.location.href = '/master_data/component_unit/'+item.id;
            };
    ...
    function showData(){
        ...
        window.util.$get('/api/component_unit/list',{
            query   : query.value,
            page    : page,
            order   : order,
            order_by: orderBy,
    ...
    createBtn.onclick = ()=>{
        document.location.href = '/master_data/component_unit/create';
    }
