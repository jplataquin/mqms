                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled="true" class="form-control @if($grand_total_amounts['contract'] < $grand_total_amounts['material']) is-invalid non-conforming @endif" value="P {{ number_format($grand_total_amounts['material'],2) }}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="module">
    ...
    function nonConforming(){
        ...
        if(total){
            window.util.alert('Warning',total+' non-conforming item(s)');
        }
    }
