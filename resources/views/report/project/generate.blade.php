                ...
                @foreach($contract_item as $component_id => $component)
                    ...
                    <tr>
                        <td colspan="2" style="padding-left:1em" class="component">
                            <a classs="link-offset-2 link-underline link-underline-opacity-0" href="/project/section/contract_item/component/{{$component_id}}" hx-boost="true" hx-select="#content" hx-target="#main">
